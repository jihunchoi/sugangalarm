...
class AlarmsControllerTest < ActionController::TestCase
  ...
  test "should create alarm" do
    assert_difference('Alarm.count') do
      post :create, alarm: { alarmed: @alarm.alarmed, email: @alarm.email, lecturer: @alarm.lecturer, subject_code: @alarm.subject_code }
    end
  ...
  test "should update alarm" do
    patch :update, id: @alarm, alarm: { alarmed: @alarm.alarmed, email: @alarm.email, lecturer: @alarm.lecturer, subject_code: @alarm.subject_code }
    assert_redirected_to alarm_path(assigns(:alarm))
  end
